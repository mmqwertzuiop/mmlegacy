...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Inner wrapper — aligns with page content */}
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 48px', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        {/* Logo */}
